@{
  ...
  FunctionsToExport = 'Get-AzPurviewAccount', 'Get-AzPurviewInstance', 'Invoke-AzPurviewHeadAccount', 'Invoke-AzPurviewHeadInstance', 'New-AzPurviewAccount', 'New-AzPurviewInstance', 'New-AzPurviewIotHubSettingsObject', 'Remove-AzPurviewAccount', 'Remove-AzPurviewInstance', 'Test-AzPurviewNameAvailability', 'Update-AzPurviewAccount', 'Update-AzPurviewInstance', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
